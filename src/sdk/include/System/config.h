...
#define ACC_INT_2_MASK (BIT64(13))
...
#define DOWN_BTN_MASK (BIT64(DOWN_BTN_PIN))
#define ACC_INT_MASK  (BIT64(14))
#define ACC_INT_2_MASK (BIT64(12))
#define BTN_PIN_MASK  (MENU_BTN_MASK|BACK_BTN_MASK|UP_BTN_MASK|DOWN_BTN_MASK)
...
// battery
#define WATCHY_DEFAULT_BATTERY_CAPACITY_MAH 200.0f
#define WATCHY_BATTERY_EMPTY_VOLTAGE 2.65f
#define WATCHY_BATTERY_FULL_VOLTAGE 3.95f
// time conversion
#ifndef uS_TO_S_FACTOR
#define uS_TO_S_FACTOR 1000000ULL                        // Conversion factor for micro seconds to seconds
#endif
#ifndef ADC_VOLTAGE_DIVIDER
#define ADC_VOLTAGE_DIVIDER ((360.0f + 100.0f) / 360.0f) // Voltage divider at battery ADC
#endif
// wifi
#define WIFI_CONNECT_TIMEOUT 10
#define WIFI_AP_TIMEOUT 180
#define WIFI_AP_ABSOLUTE_TIMEOUT 600
#define WIFI_PORTAL_SERVICE_INTERVAL_MS 50
