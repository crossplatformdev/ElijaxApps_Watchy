...
class WatchyDisplay : public GxEPD2_EPD
{
  public:
    // attributes
    static const unsigned short WIDTH = 200;
    static const unsigned short WIDTH_VISIBLE = WIDTH;
    static const unsigned short HEIGHT = 200;
    ...
    // constructor
    WatchyDisplay();
    void initWatchy(bool forceFullRefresh = false);
    void ensureInitialized();
    bool initializedThisWake() const;
    bool initialFullRefreshPending() const;
