...
#define WATCHY_BCD_HAS_PUBSUBCLIENT 1
#else
#define WATCHY_BCD_HAS_PUBSUBCLIENT 0
#endif
...
extern RTC_DATA_ATTR bool bcd_show_mqqt_data;
extern RTC_DATA_ATTR int16_t bcd_alarm_timer;
...
// Color settings
extern RTC_DATA_ATTR bool bcd_dark_mode;
// NOTE: Global theme is authoritative; do not use per-face dark mode toggles.
#define FOREGROUND_COLOR    (UiSDK::getWatchfaceFg(BASE_POLARITY))
#define BACKGROUND_COLOR    (UiSDK::getWatchfaceBg(BASE_POLARITY))
...
class BCDWatchyBase : public Watchy {
    public:
        BCDWatchyBase();
    ...
    using WatchyBase = BCDWatchyBase;
