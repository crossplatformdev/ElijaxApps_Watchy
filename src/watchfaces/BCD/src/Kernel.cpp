...
void Kernel::deep_sleep(){
    // Some hardware variants (e.g. ESP32-S3 Watchy V3) do not wire an RTC interrupt pin.
    // Guard against invalid pin values (e.g. -1) and cast to the expected type.
#if defined(RTC_PIN) && (RTC_PIN >= 0)
