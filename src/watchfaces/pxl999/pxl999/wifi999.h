...
static const char *const accessPoints[] = {"SSID-NAME-1", "SSID-NAME-2", "SSID-NAME-3"};
static const char *const apPasswords[] = {"SSID-PASS-1", "SSID-PASS-2", "SSID-PASS-3"};
...
static const char *const cityAbbv[] = {"HOME", "GPT" , "PHNE"};
...
static const char *const cityNames[] = {"5143022", "GREENPORT" , "RIVERHEAD"};

static const int accessPointCount = sizeof(accessPoints) / sizeof(accessPoints[0]); // number of known networks

String Pxl999WatchyBase::getCityAbbv() {
  String scity;
  if (pxl999_cityNameID == 999) {
    scity = "RTC";
  } else {
    scity = cityAbbv[pxl999_cityNameID];
  }
  return scity;
}

String Pxl999WatchyBase::getCityName() {
  String scity;
  if (pxl999_cityNameID == 999) {
    scity = "RTC";
  } else {
    scity = cityNames[pxl999_cityNameID];
  }
  return scity;
}

void Pxl999WatchyBase::disableWiFi() {
  WiFi.mode(WIFI_OFF);
...
bool Pxl999WatchyBase::connectWiFi() {
