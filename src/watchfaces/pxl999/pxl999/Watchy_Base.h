...
extern RTC_DATA_ATTR bool pxl999_twelve_mode;

extern RTC_DATA_ATTR bool pxl999_debugger;
extern RTC_DATA_ATTR weatherData pxl999_latestWeather;
extern RTC_DATA_ATTR char pxl999_city;
extern RTC_DATA_ATTR String pxl999_cityName;
extern RTC_DATA_ATTR int pxl999_cityNameID;
extern RTC_DATA_ATTR unsigned long pxl999_startMillis;
extern RTC_DATA_ATTR int8_t pxl999_temperature;
extern RTC_DATA_ATTR int16_t pxl999_weatherConditionCode;
...
class Pxl999WatchyBase : public Watchy {
    public:
        Pxl999WatchyBase();
        virtual void init();
    ...
    using WatchyBase = Pxl999WatchyBase;
