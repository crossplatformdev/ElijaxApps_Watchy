...
void BinaryBlocks_Watchface::drawWatchFace(){
    ...
    UiSDK::fillScreen(display, secondaryColor);
    
    UiSDK::fillRect(display, 16, 16, 170, 170, primaryColor);
    UiSDK::fillRect(display, 61, 61, 80, 80, secondaryColor);
    ...
    if(hourD1==1){
        UiSDK::fillRect(display, 61, 109, 16, 16, primaryColor);
    }
    if(hourD1==2){
        UiSDK::fillRect(display, 61, 77, 16, 16, primaryColor);
    }
    
    if(hourD2/8 >= 1){
        UiSDK::fillRect(display, 125, 63, 16, 16, primaryColor);
    }
    if((hourD2%8)/4 >= 1){
        UiSDK::fillRect(display, 125, 83, 16, 16, primaryColor);
    }
    if((hourD2%4)/2 >= 1){
        UiSDK::fillRect(display, 125, 103, 16, 16, primaryColor);
    }
    if(hourD2%2 == 1){
        UiSDK::fillRect(display, 125, 123, 16, 16, primaryColor);
    }
    
    
    if(minuteD1/4 >= 1){
        UiSDK::fillRect(display, 16, 60, 16, 16, secondaryColor);
    }
    if((minuteD1%4)/2 >= 1){
        UiSDK::fillRect(display, 16, 92, 16, 16, secondaryColor);
    }
    if(minuteD1%2 == 1){
        UiSDK::fillRect(display, 16, 124, 16, 16, secondaryColor);
    }
    
    if(minuteD2/8 >= 1){
        UiSDK::fillRect(display, 170, 44, 16, 16, secondaryColor);
    }
    if((minuteD2%8)/4 >= 1){
        UiSDK::fillRect(display, 170, 76, 16, 16, secondaryColor);
    }
    if((minuteD2%4)/2 >= 1){
        UiSDK::fillRect(display, 170, 108, 16, 16, secondaryColor);
    }
    if(minuteD2%2 == 1){
        UiSDK::fillRect(display, 170, 140, 16, 16, secondaryColor);
    }
    ...
    if(hands){
        ...
        UiSDK::fillCircle(display, hourX, hourY, 7, secondaryColor);
        ...
        UiSDK::fillCircle(display, minutesX, minutesY, 7, primaryColor);
    }
}
