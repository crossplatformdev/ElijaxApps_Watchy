...
static float lat = 48.8534;
static float lon = 2.3488;

// Translations of day of the week, starting at sunday (and ending at sunday too)
static const char* daysOfWeek[] = {"dimanche", "lundi", "mardi", "mercredi", "jeudi", "vendredi", "samedi", "dimanche"};
// Very short month names, january to december. For the "details" mode, so should be short to be shown on the circle
static const String shortMonths[] = {"ja", "fe", "ma", "av", "ma", "ju", "ji", "ao", "se", "oc", "no", "de"};
 ...
 */
static int batteryVMax = 4200;
static int batteryVMin = 3500;
