...
extern RTC_DATA_ATTR bool dktime_twelve_mode;
extern RTC_DATA_ATTR bool dktime_playAnim;
...
class DkTimeWatchyBase : public Watchy {
    public:
        DkTimeWatchyBase();
        virtual void init();
    ...
    using WatchyBase = DkTimeWatchyBase;
