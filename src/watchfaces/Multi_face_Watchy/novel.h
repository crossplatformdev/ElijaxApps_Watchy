// Global vars
static int16_t lineheight = 24;
static int16_t curx = 68;
static int16_t cury = 12 + lineheight;
...
// Text drawing
void WatchyBrain::drawPoeFace(float batt) {
  ...
  const uint16_t bg = UiSDK::getWatchfaceBg(BASE_POLARITY);
      ...
      //drawbg
      display.drawBitmap(4, 4, Raven, 60, 60, fg);
