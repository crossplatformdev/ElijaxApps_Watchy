void WatchyBrain::drawCaptn(float batt) {
    ...
    display.drawBitmap(0,0, captnwednesday_img, 200, 200, bg);
...
/*
  ...
  */  
    ...
    // battery UI (classic 7_SEG style)
    ...
    for(int8_t batterySegments = 0; batterySegments < batteryLevel; batterySegments++){
      display.fillRect(159, 151 + (batterySegments * (BATTERY_SEGMENT_SPACING-2)), BATTERY_SEGMENT_HEIGHT-3, BATTERY_SEGMENT_WIDTH-2, fg);
    } //  END OF Draw Battery
    ...
    display.print("Steps");
    display.drawFastHLine(159,184, 40, fg);
