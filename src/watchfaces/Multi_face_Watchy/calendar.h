//uCBill/calendar
void WatchyBrain::drawCalendar(float batt) {
    ...
    // draw background
    display.drawBitmap(0,0, calendar_grid, 200, 200, fg);
...
//      Ref: frame= -168:1=Sun, -140:1=Mon, -112:1=Tue, -84::1=Wed, -56:1=Thu, -28:1=Fri, 1:1=Sat
        display.drawBitmap(frame, 58, calendar31n, 367, 142, fg);
        }
        else if (days >= 30) {
        display.drawBitmap(frame, 58, calendar30n, 367, 142, fg);
        }
        else if (days >= 29) {
        display.drawBitmap(frame, 58, calendar29n, 367, 142, fg);
        }
        else if (days >= 28) {
        display.drawBitmap(frame, 58, calendar28n, 367, 142, fg);
        }
    ...
    // highlight calendar day
        ...
        if (wkday == 4) {
        display.drawBitmap(x,y, block35x34, 35, 34, fg);
        }
        display.drawBitmap(x,y, block34x34, 35, 34, fg);
