...
{
  UiSDK::drawTriangle(display, center.x + v1.x, center.y + v1.y, center.x + v2.x, center.y + v2.y, center.x + v3.x, center.y + v3.y, color);
}

void TriangleWatchy::drawTriangleFill(Vector v1, Vector v2, Vector v3, Vector center, uint16_t color)
{
  UiSDK::fillTriangle(display, center.x + v1.x, center.y + v1.y, center.x + v2.x, center.y + v2.y, center.x + v3.x, center.y + v3.y, color);
}
...
void TriangleWatchy::drawTime(uint16_t fgColor, uint16_t bgColor)
{
  int hour = currentTime.Hour;
  int minute = currentTime.Minute;

  drawTriangleFill(TOP_TICK_1, TOP_TICK_2, TOP_TICK_3, {100, 1}, fgColor);
  drawTriangleFill(TOP_TICK_1, TOP_TICK_2, TOP_TICK_4, {100, 1}, bgColor);
  drawTriangle(TOP_TICK_1, TOP_TICK_2, TOP_TICK_3, {100, 1}, fgColor);
  ...
  {    
    ...
    drawTriangleFill(corner1, corner2, corner3, {100,100}, fgColor);
    drawTriangleFill(corner1, corner2, corner4, {100,100}, bgColor);
    drawTriangle(corner1, corner2, corner3, {100,100}, fgColor);
  }
  ...
  {    
    ...
    drawTriangleFill(tick1, tick2, tick3, tickCenter1, fgColor);
    drawTriangleFill(tick1, tick2, tick4, tickCenter1, bgColor);
    drawTriangle(tick1, tick2, tick3, tickCenter1, fgColor);

    drawTriangleFill(tick1, tick2, tick3, tickCenter2, fgColor);
    drawTriangleFill(tick1, tick2, tick4, tickCenter2, bgColor);
    drawTriangle(tick1, tick2, tick3, tickCenter2, fgColor);
  }
  ...
  {    
    ...
    drawTriangleFill(tick1, tick2, tick3, tickCenter, fgColor);
    drawTriangleFill(tick1, tick2, tick4, tickCenter, bgColor);
    drawTriangle(tick1, tick2, tick3, tickCenter, fgColor);
  }
  ...
  drawTriangleFill(hour1, hour2, hour3, center, fgColor);
  drawTriangleFill(hour1, hour2, hour4, center, bgColor);
  drawTriangle(hour1, hour2, hour3, center, fgColor);

  drawTriangleFill(PIN_1, PIN_2, PIN_3, center, fgColor);
  ...
  drawTriangleFill(minute1, minute2, minute3, minuteStart, fgColor);
  ...
  drawTriangleFill(battery1, battery2, battery3, minuteStart, bgColor);
  
  drawTriangle(minute1, minute2, minute3, minuteStart, fgColor);
  
  drawTriangleFill(PIN_1, PIN_2, PIN_3, minuteStart, fgColor);

  UiSDK::drawRect(display, 1,1,199,199, fgColor);
}

void showWatchFace_Triangle(Watchy &watchy) {
  TriangleWatchy face(watchy.settings);
